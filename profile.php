...
$select="SELECT * from user_links where u_id='$uid'";
    ...
    $pinterest=$row['pinterest'];
                ...
                $uid=$_SESSION['u_id'];
                $select="SELECT * FROM `user_number_data` where u_id='$uid'";
                $run_select= mysqli_query($connect, $select);
                while ($row= mysqli_fetch_assoc($run_select)){
                   $loc=$row['loc'];
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js'></script>
		...
		<!-- Start Side Menu -->
		<nav id='top-nav'>
			<div class='logo center'><a href='#'>Nikhil</a></div> 
                        <div class='logo right' style='margin-top: -30px;margin-right: 10px;'><a href='logout.php'>Log Out</a></div><!-- LOGO -->
			...
			<div class='container'>
				<div class='row'>
					...
					<div class='my-pic center col-sm-4 col-xs-12 wow fadeInUp' data-wow-duration='0.5s' data-wow-offset='200'>
                                            <img src='$dp' alt='my profile' style='width:300px;height:300px'>
					</div>
		...
		<div class='fun-facts center' id='facts'>
			...
			<div class='container'>
                            <div class='row'>
				<div class='center col-md-12 col-sm-6'><button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-backdrop='static' data-target='#update_info1'>Edit these four values</button>
  <a onClick='window.location.reload()' class='btn btn-info btn-lg'>
          <span class='glyphicon glyphicon-refresh'></span> Refresh
        </a>

</div>
                                <div class='modal fade' id='update_info1' role='dialog'>
                                <div class=''>
                                    <div class='modal-content' >
                                        <div class='modal-header'>
                                        <button type='button' class='close' data-dismiss='modal'>&times;</button>
                                        <h4 class='modal-title'>Edit Numbers</h4>
                                        </div>
                                        <div class='modal-body'>
										<div class='container'>
                                        <form onsubmit='return edit_form();' id='edit_form'>
										<div class='row'>
											<div class='col-md-4'>
												<div class='form-group'>
													<label for='loc'>Enter Lines of codes</label>
													<input type='number' class='form-control' value='$loc' placeholder='' id='loc'>
												</div>
											</div>
											<div class='col-md-4'>
												<div class='form-group'>
													<label for='projects'>Enter Projects Done</label>
													<input type='number' class='form-control' placeholder='' value='$projects' id='projects'>
												</div>
											</div>
											<div class='col-md-4'>
												<div class='form-group'>
													<label for='coc'>Enter Cups of coffee</label>
													<input type='number' class='form-control' placeholder='' value='$coffee' id='coc'>
												</div>
											</div>
                                            ...
                                            <div class='form-group'>
                                                <button id='sub' class='btn btn-info btn-block'>Update</button> 
                                            </div>
										</div>
                                        </form>
		...
		<div class='technical-skills center' id='skills'>
			...
			<div class='container'>
				...
				<div class='skills-wrapper row' >
                                    <div id='ret_data2'>
                                        <div class='center col-md-12 col-sm-6'><button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-backdrop='static' data-target='#update_info2'>Edit these four values</button>
<a onClick='window.location.reload()' class='btn btn-info btn-lg'>
          <span class='glyphicon glyphicon-refresh'></span> Refresh
        </a>
</div>
                                        <div class='modal fade' id='update_info2' role='dialog'>
                                <div class=''>
                                    <div class='modal-content' >
                                        <div class='modal-header'>
                                        <button type='button' class='close' data-dismiss='modal'>&times;</button>
                                        ...
                                        <div class='modal-body'>
										<div class='container'>
                                        <form onsubmit='return edit_form2();' id='edit_form2'>
										<div class='row'>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='ts1v'>Rate your technical skill 1</label>
													<input type='number' value='$ts1' class='form-control' placeholder='' id='ts1v'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='ts2v'>Rate your technical skill 2</label>
													<input type='number' value='$ts2' class='form-control' placeholder='' id='ts2v'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='ts3v'>Rate your technical skill 3</label>
													<input type='number' value='$ts3' class='form-control' placeholder='' id='ts3v'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='ts4v'>Rate your technical skill 4</label>
													<input type='number' value='$ts4'  class='form-control' placeholder='' id='ts4v'>
												</div>
											</div>
                                            <div class='col-md-6'>
												<div class='form-group'>
													<label for='os1v'>Rate your communication skill</label>
													<input type='number' value='$os1' class='form-control' placeholder='' id='os1v'>
												</div>
											</div>
                                             <div class='col-md-6'>
												<div class='form-group'>
													<label for='os2v'>Rate your organisation skill</label>
													<input type='number' value='$os2' class='form-control' placeholder='' id='os2v'>
												</div>
											</div>
                                            <div class='col-md-6'>
												<div class='form-group'>
													<label for='os3v'>Rate your visual design skill</label>
													<input type='number' value='$os3' class='form-control' placeholder='' id='os3v'>
												</div>
											</div>
                                            <div class='col-md-6'>
												<div class='form-group'>
													<label for='os4v'>Rate your programming skill</label>
													<input type='number' value='$os4' class='form-control' placeholder='' id='os4v'>
												</div>
											</div>
                                            <div class='col-md-6'>
												<div class='form-group'>
													<label for='os5v'>Rate your planning skill</label>
													<input type='number' value='$os5' class='form-control' placeholder='' id='os5v'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='os6v'>Rate your learning skill</label>
													<input type='number' value='$os6' class='form-control' placeholder='' id='os6v'>
												</div>
											</div>
                                            
                                            <div class='form-group'>
                                                <button id='submit' class='btn btn-info btn-block'>Update</button> 
                                            </div>
										</div>
                                        </form>
									</div>
					...
					<!-- main skill No. 1 -->
						...
						<div class='chart center' data-percent='$ts1'>
					...
					<!-- main skill No. 2 -->					
					<div class='skill col-md-3 col-sm-6'>
						<div class='chart center' data-percent='$ts2'>
					...
					<!-- main skill No. 3 -->
					<div class='skill col-md-3 col-sm-6'>
						<div class='chart center' data-percent='$ts3'>
					...
					<!-- main skill No. 4 -->
					<div class='skill col-md-3 col-sm-6'>
						<div class='chart center' data-percent='$ts4'>
				...
				<div class='other-skills'>
					...
					<div class='skills-wrapper row'>
						...
						<div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os1 data-tooltip='true' data-label='communication' data-show-values='true' data-unit='%'></div>
						</div>
                                                <div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os2 data-tooltip='true' data-label='organisation' data-show-values='true' data-unit='%'></div>
						</div>
						<div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os3'' data-tooltip='true' data-label='visual design' data-show-values='true' data-unit='%'></div>
						</div>
						
						<!-- Skill No. 4 -->
						<div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os4' data-tooltip='true' data-label='programming' data-show-values='true' data-unit='%'></div>
						</div>
						<!-- Skill No. 5 -->
						<div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os5' data-tooltip='true' data-label='planning' data-show-values='true' data-unit='%'></div>
						</div>
						<!-- Skill No. 6 -->
						<div class='bar_group col-md-6 col-xs-12' data-max='100'>
							<div class=' bar_group__bar thick elastic' data-value='$os6' data-tooltip='true' data-label='learning' data-show-values='true' data-unit='%'></div>
						</div>
						<!-- Skill No. 7 -->
			...
			<div class='container'>
				<div class='row'>
					...
					<div class='col-md-12 col-xs-12 links'>
                                            ...
                                            <div id='ret_data3'>
                                        <div class='center col-md-12 col-sm-6'><br><button type='button' class='btn btn-primary btn-lg' data-toggle='modal' data-backdrop='static' data-target='#update_info3'>Edit these Links</button>
<a onClick='window.location.reload()' class='btn btn-info btn-lg'>
          <span class='glyphicon glyphicon-refresh'></span> Refresh
        </a>
</div><br>
                                        <div class='modal fade' id='update_info3' role='dialog'>
                                <div class=''>
                                    <div class='modal-content' >
                                        <div class='modal-header'>
                                        <button type='button' class='close' data-dismiss='modal'>&times;</button>
                                        ...
                                        <div class='modal-body'>
										<div class='container'>
                                        <form onsubmit='return edit_form3();' id='edit_form3'>
										<div class='row'>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='fb'>Facebook Profile address</label>
													<input type='text' class='form-control' value='$fb' placeholder='' id='fb'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='tweet'>Twitter Profile address</label>
													<input type='text' class='form-control' value='$tweet' placeholder='' id='tweet'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='github'>Github Profile address</label>
													<input type='text' class='form-control' value='$github' placeholder='' id='github'>
												</div>
											</div>
                                            <div class='col-md-6'>
												<div class='form-group'>
													<label for='linkedin'>Linkedin Profile address</label>
													<input type='text' class='form-control' value='$linkedin' placeholder='' id='linkedin'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='gplus'>G+ Profile address</label>
													<input type='text' class='form-control' value='$gplus' placeholder='' id='gplus'>
												</div>
											</div>
											<div class='col-md-6'>
												<div class='form-group'>
													<label for='pinterest'>Pinterest Profile address</label>
													<input type='text' class='form-control' value='$pinterest' placeholder='' id='pinterest'>
												</div>
											</div>
						...
						<div class='icon-wrapper center'>
							<!-- Facebook Link -->
							<a href='$fb' class='icon fb'>
								<i class='fa fa-facebook'></i>
								<i class='fa fa-facebook'></i>
							</a>
							<!-- Twitter Link -->
                                                        <a href='$tweet' class='icon tw'>
								<i class='fa fa-twitter'></i>
								<i class='fa fa-twitter'></i>
							</a>
							<!-- Github Link -->
							<a href='$github' class='icon gh'>
								<i class='fa fa-github'></i>
								<i class='fa fa-github'></i>
							</a>
							<!-- Google Plus Link -->
							<a href='$gplus' class='icon gp'>
								<i class='fa fa-google-plus'></i>
								<i class='fa fa-google-plus'></i>
							</a>
							<!-- Linkedin Link -->
							<a href='$linkedin' class='icon lin'>
								<i class='fa fa-linkedin'></i>
								<i class='fa fa-linkedin'></i>
							</a>
							<!-- Pinterest Link -->
							<a href='$pinterest' class='icon pin'>
		...
		<script src='js/jquery.appear2.js'></script>
		<!-- Bootstrap js file -->
